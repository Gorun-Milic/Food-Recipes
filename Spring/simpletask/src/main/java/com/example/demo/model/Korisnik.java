...
public class Korisnik implements Serializable {
	...
	public String toString() {
		return "Korisnik [idkorisnik=" + idkorisnik + ", email=" + email + ", godiste=" + godiste + ", ime=" + ime
				+ ", korisnickoime=" + korisnickoime + ", lozinka=" + lozinka + ", masa=" + masa + ", prezime="
				+ prezime + ", telefon=" + telefon + ", visina=" + visina + "]";
	}
